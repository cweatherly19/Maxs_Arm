...
screen.addstr('Hit q to quit. Use the w, a, s, and d to move. Value of Motor 2: %d' %position2)
#to read key inputs
key = ''
...
while key != ord('q'):
    ...
    key = screen.getch()
    screen.clear()
    screen.addstr('Hit q to quit. Use the w, a, s, and d to move. Position of Motor 2: %d' %position2)
